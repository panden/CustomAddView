 ...
 */
public class Add2 extends AddViewHolderCommon {
    ...
    public View getAddView(Context context, ViewGroup parentView) {
        return View.inflate(context, R.layout.layout2, null);
    }
    ...
    public void initData() {
        et.setText("Add2 extends AddViewHolderCommon");
    ...
    public void onBindParentViewAfter(ViewGroup parentView) {
        ...
        System.out.println("=========================Add2 onBindParentViewAfter");
    }
